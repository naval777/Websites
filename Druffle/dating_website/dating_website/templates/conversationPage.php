...
$(document).ready(function() {
	...
	window.setInterval(function(){
	 $.post('index.php?action=loadMessage', load_data,  function(data) {
	...
	$("#message").keypress(function(evt) {
		if(evt.which == 13) {
				...
				$.post('index.php?action=shout', post_data, function(data) {
...
{
?>
 <form name="search_messages_of_a_user" id="form2" action="index.php?action=loadMessageByUser" method="POST" >
