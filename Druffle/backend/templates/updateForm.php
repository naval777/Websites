...
<form name="" action="/backend/main.php?action=updateUserImage" method="POST" enctype="multipart/form-data">
...
update Password
<form name="" action="/backend/main.php?action=updatePassword" method="POST" enctype="multipart/form-data">
	...
	Update Basic Info			 
<form name="update_form" action="/backend/main.php?action=update" method="POST" enctype="multipart/form-data">
